...
const Navbar: React.FC = () => {
  return (
    <nav className="relative flex justify-between items-center ">
      ...
      <div className="flex justify-center items-center w-full absolute h-full px-6 py-3 bg-gradient-to-r via-blue-600/80 from-blue-700/55 to-blue-700/80  text-center z-10">
